...
test("renders separate English and Chinese control desks", async () => {
  ...
  assert.match(en, /Trace the X Trending Event/); assert.doesNotMatch(en, /核对背后的帖子。/); assert.match(en,/Key accounts/); assert.match(en,/@SparkLab_City/); assert.match(en,/@marclou/);
